...
void My_Init()
{
    ...
    for (unsigned int i = 0; i < shapes[0].mesh.indices.size(); i += 3)
    {
        ...
        dp1[0] = shapes[0].mesh.positions[idx1 * 3 + 0] - shapes[0].mesh.positions[idx0 * 3 + 0];
        dp1[1] = shapes[0].mesh.positions[idx1 * 3 + 1] - shapes[0].mesh.positions[idx0 * 3 + 1];
        dp1[2] = shapes[0].mesh.positions[idx1 * 3 + 2] - shapes[0].mesh.positions[idx0 * 3 + 2];

        dp2[0] = shapes[0].mesh.positions[idx2 * 3 + 0] - shapes[0].mesh.positions[idx0 * 3 + 0];
        dp2[1] = shapes[0].mesh.positions[idx2 * 3 + 1] - shapes[0].mesh.positions[idx0 * 3 + 1];
        dp2[2] = shapes[0].mesh.positions[idx2 * 3 + 2] - shapes[0].mesh.positions[idx0 * 3 + 2];

        duv1[0] = shapes[0].mesh.texcoords[idx1 * 2 + 0] - shapes[0].mesh.texcoords[idx0 * 2 + 0];
        duv1[1] = shapes[0].mesh.texcoords[idx1 * 2 + 1] - shapes[0].mesh.texcoords[idx0 * 2 + 1];

        duv2[0] = shapes[0].mesh.texcoords[idx2 * 2 + 0] - shapes[0].mesh.texcoords[idx0 * 2 + 0];
        duv2[1] = shapes[0].mesh.texcoords[idx2 * 2 + 1] - shapes[0].mesh.texcoords[idx0 * 2 + 1];
	...
	texture_data diffuse_data = load_png("../../Media/Textures/ladybug_co.png");
	GLuint tex;
	...
	texture_data normal_data = load_png("../../Media/Textures/ladybug_nm.png");
