...
void My_Display()
{
	...
	view_matrix[2] = lookAt(vec3(0.0f, 0.0f, 25.0f), vec3(0.0f, 0.0f, 0.0f), vec3(0.0f, 1.0f, 0.0f));
	view_matrix[3] = lookAt(vec3(0.0f, 25.0f, 0.0f), vec3(0.0f, 0.0f, 0.0f), vec3(0.0f, 0.0f, 1.0f));
	...
	glUniform4f(uniforms.render.color, 1.0f, 1.0f, 1.0f, 1.0f);
	glDrawElements(GL_TRIANGLES, index_count, GL_UNSIGNED_INT, 0);
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	glUniform4f(uniforms.render.color, 0.0f, 0.0f, 1.0f, 1.0f);
	glDrawElements(GL_TRIANGLES, index_count, GL_UNSIGNED_INT, 0);
	// ----- End Render Pass -----
