...
void My_Display()
{
	...
	mat4 mv2_body = rotate(Identy_Init, deg2rad(currentTime * 45.0f), vec3(0.0f, 1.0f, 0.0f));
	mv2_body = translate(mv2_body, vec3(0.0f, 0.2f, -4.0f));
	...
	scaleHead = mv_head*scaleHead*mv2_body;
	...
	scaleLeg1 = mv3_leg1*scaleLeg1*mv2_body;
	...
	scalelLeg2 = mv4_leg2* scalelLeg2*mv2_body;
	...
	scaleHand1 = mv5_hand1*scaleHand1*mv2_body;
	...
	scalelHand2 = mv6_hand2*scalelHand2*mv2_body;
